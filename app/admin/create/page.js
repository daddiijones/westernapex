...
export default function CreateShipmentPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    receiverAddress: '', receiverCity: '', receiverState: '', receiverZip: '', receiverCountry: '',
    originPort: '', destinationPort: '', carrierName: '', vesselFlightNumber: '',
    shippingMethod: 'Air Freight', incoterms: 'DAP',
    totalWeight: '', totalVolume: '', packageCount: '1',
    customsValue: '', currency: 'USD', customsStatus: 'Pending',
    dispatchDate: '', estimatedDeparture: '', estimatedArrival: '',
    packagePicture: '',
  ...
  const addItem = () => setItems([...items, { description: '', quantity: '1', weight: '', value: '' }]);
      ...
      <header style={{
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: '1.1rem', fontWeight: '700' }}>
            <span className="text-gradient">Create Shipment</span>
          </h1>
            ...
            <div className="grid-2">
              <div className="input-group">
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  <input name="trackingNumber" className="input-field" required value={formData.trackingNumber} onChange={handleChange} placeholder="WA..." style={{ flex: 1 }} />
                  <button type="button" onClick={generateTracking} className="btn-secondary btn-sm" style={{ whiteSpace: 'nowrap' }}>Generate</button>
                </div>
              </div>
              <div className="input-group">
